...
{
    public partial class Services_dbContext
    {
        private Iturnos_dbContextProcedures _procedures;

        public virtual Iturnos_dbContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new turnos_dbContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public Iturnos_dbContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class turnos_dbContextProcedures : Iturnos_dbContextProcedures
    {
        private readonly Services_dbContext _context;

        public turnos_dbContextProcedures(Services_dbContext context)
        {
            _context = context;
        }
